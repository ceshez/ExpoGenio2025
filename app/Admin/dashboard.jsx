...
export default function Dashboard() {
    ...
    const items = [   //lista de cada seccion en side bar que llevara a objeto dependiente al tipo asigando segun este
    ...
    return (
        <aside className="w-56 min-h-screen border-r bg-white pt-22">
            <div className="flex flex-col items-center py-8 border-b">
                ...
                <p className="mt-3 text-sm font-medium text-slate-700">Carlos Sánchez</p> {/*datos de usuario con base de datos*/}
            </div>
            <div className="p-4">  
